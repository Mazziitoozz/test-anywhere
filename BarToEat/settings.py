"""
Django settings for BarToEat project.
...
SECRET_KEY = '-4y2(g(=0qvhz$j!6kl2@tq%^1$i8^ag1%l%3yq(jdxf$%@_sg'
...
WSGI_APPLICATION = 'BarToEat.wsgi.application'
